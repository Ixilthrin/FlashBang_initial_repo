...
ProjectionOnlyShader::ProjectionOnlyShader()
{
	_programHandle = 0;
}
...
GLuint ProjectionOnlyShader::GetProgramHandle()
{
	return _programHandle;
}

int ProjectionOnlyShader::Setup()
{
	...
	string shaderCode = shaderSource.ReadShaderFromFile("c:/programming/ProjectDays2019/shaders/projection.vert.glsl");

...
std::string Card::getVertexShaderPath()
{
    ...
    //return "c:/programming/FlashBang/shaders/translation_and_texture.vert.glsl";
    //return "c:/programming/FlashBang/shaders/default.vert.glsl";
}

std::string Card::getFragmentShaderPath()
{
    return "c:/programming/FlashBang/shaders/texture.frag.glsl";
    //return "c:/programming/FlashBang/shaders/default.frag.glsl";
}
